...
<div class="mb-6 sm:mb-10 px-1 sm:px-0">
    ...
    <h2 class="text-xl sm:text-3xl font-extrabold text-white tracking-tight tech-glow">บันทึกงานบริการ IT Support ใหม่</h2>
    <p class="text-xs sm:text-sm text-slate-400 mt-1 font-medium">กรอกข้อมูลประวัติการแก้ไขและซ่อมบำรุงทางคอมพิวเตอร์และโสตทัศนศึกษา</p>
</div>
...
<div class="glass-card p-4 sm:p-8 rounded-2xl sm:rounded-[2rem] max-w-4xl w-full mx-auto">
    <form method="POST" action="<?= base_url('itsupport/store') ?>" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <!-- Pre-filled Recorder -->
            <div class="space-y-1.5">
                <label class="text-[10px] font-bold text-slate-400 uppercase tracking-widest pl-2">เจ้าหน้าที่ผู้ปฏิบัติงาน (ผู้ลงบันทึก)</label>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-1.5">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="its_date" required placeholder="เลือกวันเวลา..." class="datetimepicker-be w-full pl-10 pr-4 py-3 bg-slate-950/60 border border-slate-900 focus:border-cyan-500 rounded-2xl text-sm text-white outline-none transition-colors">
                </div>
        ...
        <div class="space-y-1.5">
            ...
            <textarea name="its_task" required rows="5" placeholder="พิมพ์อธิบายปัญหา อาการชำรุด หรือกระบวนการซ่อมแซมแก้ไขให้ละเอียด..." class="w-full px-4 py-3 bg-slate-950/60 border border-slate-900 focus:border-cyan-500 rounded-2xl text-sm text-white placeholder-slate-500 outline-none transition-colors resize-none"><?= old('its_task') ?></textarea>
        ...
        <div class="space-y-2">
            <label class="text-[10px] font-bold text-slate-400 uppercase tracking-widest pl-2 block">แนบภาพประกอบผลงานบริการ (แนบได้หลายรูปพร้อมกัน)</label>
            <div class="flex items-center justify-center w-full">
                <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-40 border-2 border-slate-900 border-dashed rounded-3xl cursor-pointer bg-slate-950/20 hover:bg-slate-950/50 hover:border-slate-800 transition-all duration-300">
                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                        ...
                        <p class="mb-2 text-sm text-slate-400"><span class="font-bold text-cyan-400">คลิกอัปโหลด</span> หรือเลือกหลายภาพพร้อมกัน</p>
